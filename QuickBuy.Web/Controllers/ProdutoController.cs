...
namespace QuickBuy.Web.Controllers
{
    ...
    public class ProdutoController : Controller
    {
        ...
        public IActionResult EnviarArquivo()
        {
            try
            {
                var formFile = _httpContextAccessor.HttpContext.Request.Form.Files["arquivoSelecionado"];
                var nomeArquivo = formFile.FileName;
                var extensao = nomeArquivo.Split(".").Last();
                string novoNomeArquivo = NovoNomeArquivo(nomeArquivo, extensao);
        ...
        private static string NovoNomeArquivo(string nomeArquivo, string extensao)
        {
